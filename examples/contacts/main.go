...
func SeedDatabase(db *sql.DB) {
	...
	var seedContacts []Contact = []Contact{Contact{Phone: "555-555-0001", Email: "herman.munster@mockingbird.example", FirstName: "Herman", LastName: "Munster", Address: "1313 Mockingbird Lane", City: "Mockingbird Heights", State: "CA", Zip: "90210"}, Contact{Email: "gomez.addams@cemetery.example", FirstName: "Gomez", LastName: "Addams", Address: "0001 Cemetery Lane", City: "Westfield", State: "NJ", Zip: "07090", Phone: "555-555-0002"}, Contact{Email: "fred.flintstone@bedrock.example", FirstName: "Fred", LastName: "Flintstone", Address: "301 Cobblestone Way", City: "Bedrock", State: "", Zip: "00001", Phone: "555-555-0003"}, Contact{State: "", Zip: "99999", Phone: "555-555-0004", Email: "george.jetson@spacely.example", FirstName: "George", LastName: "Jetson", Address: "Skypad Apartments", City: "Orbit City"}, Contact{State: "", Zip: "49007", Phone: "555-555-0005", Email: "homer.simpson@springfield.example", FirstName: "Homer", LastName: "Simpson", Address: "742 Evergreen Terrace", City: "Springfield"}, Contact{Zip: "11375", Phone: "555-555-0006", Email: "archie.bunker@queens.example", FirstName: "Archie", LastName: "Bunker", Address: "704 Houser Street", City: "Queens", State: "NY"}, Contact{Phone: "555-555-0007", Email: "al.bundy@chicago.example", FirstName: "Al", LastName: "Bundy", Address: "9764 Jeopardy Lane", City: "Chicago", State: "IL", Zip: "60614"}, Contact{State: "", Zip: "12345", Phone: "555-555-0008", Email: "ward.cleaver@mayfield.example", FirstName: "Ward", LastName: "Cleaver", Address: "211 Pine Street", City: "Mayfield"}, Contact{Phone: "555-555-0009", Email: "mike.brady@losangeles.example", FirstName: "Mike", LastName: "Brady", Address: "4222 Clinton Way", City: "Los Angeles", State: "CA", Zip: "91604"}, Contact{LastName: "Ricardo", Address: "623 East 68th Street", City: "New York", State: "NY", Zip: "10065", Phone: "555-555-0010", Email: "ricky.ricardo@tropicana.example", FirstName: "Ricky"}, Contact{Zip: "11233", Phone: "555-555-0011", Email: "ralph.kramden@gotham.example", FirstName: "Ralph", LastName: "Kramden", Address: "328 Chauncey Street", City: "Brooklyn", State: "NY"}, Contact{Address: "185 East 85th Street", City: "New York", State: "NY", Zip: "10028", Phone: "555-555-0012", Email: "george.jefferson@deluxe.example", FirstName: "George", LastName: "Jefferson"}, Contact{Phone: "555-555-0013", Email: "cliff.huxtable@brooklyn.example", FirstName: "Cliff", LastName: "Huxtable", Address: "10 Stigwood Avenue", City: "Brooklyn", State: "NY", Zip: "11215"}, Contact{LastName: "Tanner", Address: "1882 Gerard Street", City: "San Francisco", State: "CA", Zip: "94115", Phone: "555-555-0014", Email: "danny.tanner@sanfrancisco.example", FirstName: "Danny"}, Contact{City: "Detroit", State: "MI", Zip: "48226", Phone: "555-555-0015", Email: "tim.taylor@tooltime.example", FirstName: "Tim", LastName: "Taylor", Address: "510 Glenview Road"}, Contact{FirstName: "Ray", LastName: "Barone", Address: "320 Fowler Street", City: "Lynbrook", State: "NY", Zip: "11563", Phone: "555-555-0016", Email: "ray.barone@newsday.example"}, Contact{State: "NY", Zip: "11375", Phone: "555-555-0017", Email: "doug.heffernan@ips.example", FirstName: "Doug", LastName: "Heffernan", Address: "3121 Aberdeen Street", City: "Queens"}, Contact{Address: "31 Spooner Street", City: "Quahog", State: "RI", Zip: "02901", Phone: "555-555-0018", Email: "peter.griffin@quahog.example", FirstName: "Peter", LastName: "Griffin"}, Contact{Address: "84 Rainey Street", City: "Arlen", State: "TX", Zip: "73104", Phone: "555-555-0019", Email: "hank.hill@strickland.example", FirstName: "Hank", LastName: "Hill"}, Contact{Email: "phil.dunphy@realestate.example", FirstName: "Phil", LastName: "Dunphy", Address: "10336 Dunphy Lane", City: "Los Angeles", State: "CA", Zip: "90077", Phone: "555-555-0020"}, Contact{Address: "123 Ocean Avenue", City: "Seymours Bay", State: "NJ", Zip: "07001", Phone: "555-555-0021", Email: "bob.belcher@burgers.example", FirstName: "Bob", LastName: "Belcher"}, Contact{Address: "308 Negra Arroyo Lane", City: "Albuquerque", State: "NM", Zip: "87104", Phone: "555-555-0022", Email: "walter.white@graymatter.example", FirstName: "Walter", LastName: "White"}, Contact{FirstName: "Don", LastName: "Draper", Address: "783 Park Avenue", City: "New York", State: "NY", Zip: "10021", Phone: "555-555-0023", Email: "don.draper@scdp.example"}, Contact{Address: "1725 Slough Avenue", City: "Scranton", State: "PA", Zip: "18503", Phone: "555-555-0024", Email: "michael.scott@dundermifflin.example", FirstName: "Michael", LastName: "Scott"}, Contact{Email: "leslie.knope@pawnee.example", FirstName: "Leslie", LastName: "Knope", Address: "314 Pawnee Way", City: "Pawnee", State: "IN", Zip: "47408", Phone: "555-555-0025"}}
	var i int
...
func Main() {
	...
	err = declarative.MainWindow{Size: declarative.Size{Width: 800, Height: 600}, Layout: declarative.VBox{}, MenuItems: []declarative.MenuItem{declarative.Menu{Text: "&File", Items: []declarative.MenuItem{declarative.Action{Text: "&New Contact\tCtrl+N", OnTriggered: OnNewContact}, declarative.Action{Text: "&Edit Contact\tCtrl+E", OnTriggered: OnEditContact}, declarative.Action{OnTriggered: OnDeleteContact, Text: "&Delete Contact\tDel"}, declarative.Separator{}, declarative.Action{Text: "E&xit\tAlt+F4", OnTriggered: OnExit}}}}, Children: []declarative.Widget{declarative.TableView{AssignTo: &tableView, Model: gModel, Columns: []declarative.TableViewColumn{declarative.TableViewColumn{Title: "First Name", Width: 100}, declarative.TableViewColumn{Title: "Last Name", Width: 100}, declarative.TableViewColumn{Title: "City", Width: 120}, declarative.TableViewColumn{Title: "State", Width: 50}, declarative.TableViewColumn{Title: "Phone", Width: 120}}, OnItemActivated: OnEditContact}}, StatusBarItems: []declarative.StatusBarItem{declarative.StatusBarItem{AssignTo: &gStatusBar, Text: "Ready"}}, AssignTo: &gMainWindow, Title: "Contact Book", MinSize: declarative.Size{Height: 400, Width: 600}}.Create()
	if (err != nil) {
