StarWord 0.9.07b - a modern WordStar 7.0 clone (beta)
=====================================================
...
INSTALL / RUN
  ...
  (it opens in Windows Terminal if available). The Help menu's "Help" and
  "Whats New?" items open the HTML files above in your default browser, so
  they must stay next to StarWord.exe.

  From a prompt you can also run:  StarWord.exe [options] [file]
  Use  StarWord.exe --help  for the list of command-line options.
